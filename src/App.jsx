...
const skills = [
  ...
  { name: "Docker", iconPath: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 15h-2.5c-.28 0-.5-.22-.5-.5s.22-.5.5-.5H9v-2H7.5c-.28 0-.5-.22-.5-.5s.22-.5.5-.5H9v-2H7.5c-.28 0-.5-.22-.5-.5s.22-.5.5-.5H9V6h2v11z", category: "DevOps" },
];
