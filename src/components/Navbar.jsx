  ...
  return (
    ...
    >
      ...
      <div className="flex gap-6 text-xl text-white">
        ...
        {/* GitHub */}
        <a href="https://github.com/rrrautela" target="_blank" rel="noopener noreferrer"
          className="hover:text-black transition hover:scale-105 duration-200" aria-label="GitHub">
        ...
        <a
          ...
          className="transition hover:scale-105 duration-200"
          aria-label="LeetCode"
        >
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/1/19/LeetCode_logo_black.png"
            alt="LeetCode"
            className="w-7 h-7 opacity-80 hover:opacity-100 grayscale hover:grayscale-0 transition duration-300"
          />
        </a>


        {/* LinkedIn */}
        <a href="https://www.linkedin.com/in/harshit-singh-rautela-b31b98242/" target="_blank" rel="noopener noreferrer"
          className="hover:text-[#0077B5] transition hover:scale-105 duration-200" aria-label="LinkedIn">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" width="1em" height="1em">
        ...
        {/* Twitter */}
        <a href="https://twitter.com/kadanealgo" target="_blank" rel="noopener noreferrer"
          className="hover:text-[#1DA1F2] transition hover:scale-105 duration-200" aria-label="Twitter">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" width="1em" height="1em">
